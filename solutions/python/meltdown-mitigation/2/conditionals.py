...
def reactor_efficiency(voltage, current, theoretical_max_power):
    ...
    if power_percentage >= 80:
        ...
        return "orange"
    elif power_percentage >= 30 and power_percentage < 60:
        return "red"
    return "black"
...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    value_compared = temperature * neutrons_produced_per_second

    if value_compared < (0.9 * threshold):
        return "LOW"
    elif ((value_compared >= (0.9 * threshold)) and (value_compared <= (1.1 * threshold))) or value_compared == threshold :
        return "NORMAL"
    return "DANGER"
