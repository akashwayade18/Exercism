...
def get_rounds(number):
    ...
    list_rounds = [number, number+1, number+2]
    return list_rounds
...
def approx_average_is_average(hand):
    ...
    path1 = (hand[0] + hand[-1]) / 2 == calculated_avg
    path2 = hand[len(hand)//2] == calculated_avg
...
def average_even_is_average_odd(hand):
    ...
    even_list = hand[:len(hand): 2]
    odd_list = hand[1: len(hand)+1: 2]
